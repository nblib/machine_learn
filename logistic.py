...
def testLR():
    # 1.收集并准备数据
    dataMat, labelMat = loadDataSet(os.getcwd() + "/data/logistic_data.txt")
...
def simpleTest():
    ...
    testData = [[1, -1.076637, -3.181888], [1, 1.821096, 10.283990]]
    testDataMatx = mat(testData)

    results = sigmoid(testData * weights)
